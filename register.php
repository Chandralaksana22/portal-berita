...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $role = $_POST['role']; // Admin or Publisher
        ...
        <nav class="navbar-1-1 navbar navbar-expand-lg navbar-light p-4 px-md-4 mb-3 bg-body" style="font-family: Poppins, sans-serif">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img width="131" height="47" src="assets/media/logo-dark.svg" alt="logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    <div class="d-flex">
                        <a class="btn btn-get-started btn-get-started-blue text-white" href="index.php">News Page</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif">
            ...
            <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    ...
                    <?php if (isset($error)) : ?>
                        <p class="caption-text" style="color: red;"><?= $error ?></p>
                    <?php endif; ?>
                    <p class="caption-text">
                        Please log in using that account has<br />
                        registered on the website.
                    </p>
                    <form style="margin-top: 1.5rem" action="register.php" method="post">
                        ...
                        <div style="margin-top: 1rem; display: none">
                            <input class="input-field border-0" type="text" name="role" value="publisher" id="password-content-3-5" placeholder="Your Password" minlength="6" required />
                            <!-- <label for="" class="d-block input-label">Role</label>
                            <select class="d-flex w-100 div-input" name="role" required>
                    ...
                    <p class="text-center bottom-caption">
                        ...
                        <a href="login.php"><span class="green-bottom-caption">Login Here</span></a>
                    </p>
                </div>
            </div>
        </div>
